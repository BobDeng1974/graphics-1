...
class Example(Gtk.Window):
    ...
    def draw_gradient1(self, cr):
        ...
        lg1.add_color_stop_rgba(0.1, 1, 0, 0, 1) 
        lg1.add_color_stop_rgba(0.5, 1, 1, 1, 1) 
        lg1.add_color_stop_rgba(0.9, 0, 0, 1, 1) 
    ...
    def draw_gradient2(self, cr):        
        ...
        lg2.add_color_stop_rgba(0.1, 1, 0, 0, 1) 
        lg2.add_color_stop_rgba(0.5, 1, 1, 1, 1) 
        lg2.add_color_stop_rgba(0.9, 0, 0, 1, 1) 
